...
int LED_MATRIX[ 8 ][ 8 ] = {
  {1, 0, 0, 1, 0, 0, 0, 0}, // Instrument 1
  {0, 1, 0, 0, 1, 0, 0, 0}, // Instrument 2
  {0, 0, 1, 0, 0, 1, 0, 0}, // Instrument 3
  {1, 0, 0, 1, 0, 0, 1, 0}, // Instrument 4
  {0, 1, 0, 0, 1, 0, 0, 1}, // Instrument 5
  {0, 0, 1, 0, 0, 1, 0, 0}, // Instrument 6
  {0, 0, 0, 1, 0, 0, 1, 0}, // Instrument 7
  {0, 0, 0, 0, 1, 0, 0, 1}  // Instrument 8
};
